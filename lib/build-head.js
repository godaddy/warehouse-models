...
module.exports = function buildHead(dynamodb, models) {
  ...
  const model = dynamodb.define('build_head', {
    hashKey: 'key',
    rangeKey,
    ...
    schema: {
      ...
      version: Joi.string(),
      locale: Joi.string(),
      cdn_url: Joi.string(), // URL of CDN to be used as a base for all the artifacts
  ...
  var BuildHead = new Compat({ model, rangeKey, createKey });
